...
public class SelectProductController {
    ...
    public ResponseEntity<SelectProductResponseDto> saveSelectProduct(@RequestBody SelectProductRequestDto requestDto) {
    ...
    public ResponseEntity<SelectProductResponseDto> updateSelectProduct(@PathVariable Long id, @RequestBody SelectProductRequestDto requestDto) {
