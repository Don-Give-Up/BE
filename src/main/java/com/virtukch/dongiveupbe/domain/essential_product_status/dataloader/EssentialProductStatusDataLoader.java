package com.virtukch.dongiveupbe.domain.essential_product_status.dataloader;
...
public class EssentialProductStatusDataLoader implements CommandLineRunner {
    ...
    public EssentialProductStatusDataLoader(
        EssentialProductStatusRepository essentialProductStatusRepository) {
    ...
    public void run(String... args) throws Exception {
        // 실제 빵 가격 데이터
        Long[] prices = {
            670L, 743L, 776L, 804L, 834L, 905L, 983L, 1009L, 1270L, 1346L, 1346L, 1302L, 1526L,
            1657L, 1557L,
            1994L, 1723L, 1611L, 1867L, 1936L, 1948L, 2069L, 2994L, 1916L, 2122L, 2429L, 2612L,
            2534L
        };
        ...
        log.info("EssentialProductStatus 데이터가 라운드별로 저장되었습니다.");
    }
}
